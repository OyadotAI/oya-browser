  ...
  return (
    <>
      ...
      <ul className="list-disc list-inside space-y-1 mb-4 text-[15px] leading-relaxed">
        ...
        <li>
          <strong>Personas</strong> — one identity each. Create with a chosen device and a live fingerprint preview;
          edit name, cap, proxy pin and MFA; the device itself is locked, with <em>Clone</em> for when you want a
          different one.
        </li>
        <li>
  ...
  return (
    <>
      ...
      <p className="mb-3 text-[15px] leading-relaxed">
        ...
        SDK, CLI, an MCP config, curl — and for CDP-backed browsers, a Playwright{' '}
        <InlineCode>connectOverCDP</InlineCode> URL. Snippets are written for this deployment and your key; the key is
        masked until you ask, and copy always copies the real one.
      </p>
