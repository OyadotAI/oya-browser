          ...
          <Table
            ...
            rows={[
              [
                ...
                <a key="mac" href="/downloads/Oya.Browser-1.0.81-universal.dmg" className="text-accent hover:text-accent-hover transition-colors">Oya Browser.dmg</a>,
              ],
              [
                'Windows (x64)',
                <a key="win" href="/downloads/Oya.Browser-1.0.81-x64.exe" className="text-accent hover:text-accent-hover transition-colors">Oya Browser.exe</a>,
              ],
              [
                'Linux (x64)',
                <a key="linux" href="/downloads/Oya.Browser-1.0.81-x64.AppImage" className="text-accent hover:text-accent-hover transition-colors">Oya Browser.AppImage</a>,
              ],
            ]}
          />
          <p className="mb-3 text-[15px] leading-relaxed">
