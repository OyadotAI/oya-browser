...
const ITEMS: [string, string, string][] = [
  ...
  ['HTTP, HTTPS or SOCKS5 proxy per persona, with DNS leak prevention', 'proxy-support', 'P'],
  ['Anti-Detection Stealth', 'stealth', 'H3'],
  ['Removes Electron markers, fixes window.chrome, navigator.webdriver, plugins', 'stealth', 'P'],
  ['Choosing a persona', 'choosing-a-persona', 'H2'],
  [
    'A persona is created through the API and chosen when the browser starts; clone it to vary the device',
    'choosing-a-persona',
    'P',
  ],
