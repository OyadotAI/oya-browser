...
credentials.set(PERSONA, 'https://www.radmd.com/RadMD/Common/Login.aspx', {
  username: 'alice',
...
assert(
  credentials.lookup(PERSONA, 'carecore.evicore.com')?.username === 'bob',
...
assert(
  mfa.describe(PERSONA, 'radmd.com').configured && !mfa.describe(PERSONA, 'radmd.com').domain,
...
assert(
  mfa.list(PERSONA).length === 1 && mfa.list(PERSONA)[0].domain === 'evicore.com',
